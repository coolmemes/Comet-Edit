...
public class FreezeBlockFloorItem extends RoomItemFloor {
    ...
    public FreezeBlockFloorItem(long id, int itemId, Room room, int owner, int x, int y, double z, int rotation, String data) {
    ...
    public void onEntityStepOn(RoomEntity entity) {
        ...
        freezePlayer.getEntity().getPlayer().getAchievements().progressAchievement(AchievementType.ACH_78, 1);
