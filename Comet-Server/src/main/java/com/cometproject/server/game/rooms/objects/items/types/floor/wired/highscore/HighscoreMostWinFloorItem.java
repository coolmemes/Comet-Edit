...
import com.cometproject.server.game.rooms.objects.items.types.floor.wired.data.scoreboard.ResetItemData;
import com.cometproject.server.game.rooms.objects.items.types.floor.wired.data.scoreboard.TeamScoreboardData;
...
import com.cometproject.server.storage.queries.items.WiredHighscoreDao;
import com.cometproject.server.utilities.JsonFactory;
import com.cometproject.server.utilities.comporators.HighscoreTeamComparator;
...
public class HighscoreMostWinFloorItem extends RoomItemFloor {
    ...
    public HighscoreMostWinFloorItem(long id, int itemId, Room room, int owner, String ownerName, int x, int y, double z, int rotation, String data) {
