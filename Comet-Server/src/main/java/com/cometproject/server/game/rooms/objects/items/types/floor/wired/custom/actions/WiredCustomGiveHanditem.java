 ...
 */
public class WiredCustomGiveHanditem extends WiredActionItem {
    /**
     ...
     */
    public WiredCustomGiveHanditem(long id, int itemId, Room room, int owner, int x, int y, double z, int rotation, String data) {
    ...
    public void onTickComplete() {
        ...
        int handItem = Integer.parseInt(this.getWiredData().getText());

        if (handItem >= 0) {
            playerEntity.getPlayer().getEntity().carryItem(handItem, false);
        }
