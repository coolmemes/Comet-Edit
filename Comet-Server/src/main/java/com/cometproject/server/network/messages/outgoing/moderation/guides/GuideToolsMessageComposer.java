package com.cometproject.server.network.messages.outgoing.moderation.guides;
...
public class GuideToolsMessageComposer extends MessageComposer {
    ...
    public void compose(IComposer msg) {
        ...
        msg.writeInt(NetworkManager.getInstance().getSessions().getModerationSize());
        msg.writeInt(this.activeGuideCount);
        msg.writeInt(this.activeGuardianCount);
    }
}
