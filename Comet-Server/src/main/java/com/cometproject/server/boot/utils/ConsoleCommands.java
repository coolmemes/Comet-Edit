                    ...
                    try {
                        ...
                        if (input != null && input.startsWith("/")) {
                            switch (input.split(" ")[0]) {
                                ...
                                case "/toggledelay":
                                    boolean newValue = !Comet.allowToUseDelayOnWireds;
                                    Comet.allowToUseDelayOnWireds = newValue;

                                    System.out.println("Delay on wired now is " + (newValue ? "allowed" : "not allowed"));
                                    break;
                            }
                        } else {
                            log.error("Invalid command");
